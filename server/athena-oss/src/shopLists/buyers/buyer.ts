...
export const BUYERS: alt.Vector3[] = [
    ...
    { x: 21.903297424316406, y: -1108.140625, z: 29.785400390625 } as alt.Vector3,
    { x: -330.4879150390625, y: 6083.93408203125, z: 31.4534912109375 } as alt.Vector3,
    { x: 1693.3714599609375, y: 3760.12744140625, z: 34.6885986328125 } as alt.Vector3,
    { x: -1117.4769287109375, y: 2698.839599609375, z: 18.5465087890625 } as alt.Vector3,
    { x: 2567.301025390625, y: 294.1450500488281, z: 108.7266845703125 } as alt.Vector3,
    { x: 251.92088317871094, y: -50.36043930053711, z: 69.9384765625 } as alt.Vector3,
    { x: -1305.982421875, y: -394.4703369140625, z: 36.6937255859375 } as alt.Vector3,
    { x: -661.9384765625, y: -935.2879028320312, z: 21.8154296875 } as alt.Vector3,
    { x: 842.1626586914062, y: -1033.81982421875, z: 28.1845703125 } as alt.Vector3,
    { x: 810.0263671875, y: -2157.177978515625, z: 29.6168212890625 } as alt.Vector3,
    { x: -1093.7142333984375, y: -834.5142822265625, z: 23.028564453125 } as alt.Vector3,
    { x: -560.1758422851562, y: 286.4307556152344, z: 82.17138671875 } as alt.Vector3,
    { x: -1394.1494140625, y: -603.96923828125, z: 30.3077392578125 } as alt.Vector3,
    { x: -1377.6131591796875, y: -627.3362426757812, z: 30.813232421875 } as alt.Vector3,
    { x: 127.16043853759766, y: -1283.4989013671875, z: 29.2630615234375 } as alt.Vector3,
    { x: 2748.77392578125, y: 3472.442626953125, z: 55.67741012573242 - 1 } as alt.Vector3,
];

// Used to give all the shops are different blip, just copy the line as often as you need it.
export const buyerBlips = [
    { sprite: 59, color: 2, text: '24/7 shop', scale: 1 },
    { sprite: 59, color: 2, text: 'LTD', scale: 1 },
    { sprite: 59, color: 2, text: 'Robs Liquor', scale: 1 },
    { sprite: 59, color: 2, text: 'LTD', scale: 1 },
    { sprite: 59, color: 2, text: '24/7 shop', scale: 1 },
    { sprite: 59, color: 2, text: 'LTD', scale: 1 },
    { sprite: 59, color: 2, text: 'Robs Liquor', scale: 1 },
    ...
    { sprite: 59, color: 2, text: '24/7 shop', scale: 1 },
    { sprite: 59, color: 2, text: '24/7 shop', scale: 1 },
    { sprite: 59, color: 2, text: 'Juice', scale: 1 },
    { sprite: 59, color: 2, text: 'Liquor ACE', scale: 1 },
    { sprite: 59, color: 2, text: '24/7 shop', scale: 1 },
    { sprite: 59, color: 2, text: 'LTD', scale: 1 },
    { sprite: 59, color: 2, text: '24/7 shop', scale: 1 },
    { sprite: 59, color: 2, text: '24/7 shop', scale: 1 },
    { sprite: 59, color: 2, text: 'LTD', scale: 1 },
    { sprite: 110, color: 2, text: 'Ammunation', scale: 1 },
    { sprite: 110, color: 2, text: 'Ammunation', scale: 1 },
    { sprite: 110, color: 2, text: 'Ammunation', scale: 1 },
    { sprite: 110, color: 2, text: 'Ammunation', scale: 1 },
    { sprite: 110, color: 2, text: 'Ammunation', scale: 1 },
    ...
    { sprite: 110, color: 2, text: 'Ammunation', scale: 1 },
    { sprite: 110, color: 2, text: 'Ammunation', scale: 1 },
    { sprite: 93, color: 48, text: 'Vespucci Police Dept bár', scale: 1 },
    { sprite: 93, color: 48, text: 'Tequi-la-la', scale: 1 },
    { sprite: 93, color: 48, text: 'Bahama Mamas', scale: 1 },
    { sprite: 93, color: 48, text: 'Bahama Mamas', scale: 1 },
    { sprite: 93, color: 48, text: 'Vanilla Unicorn', scale: 1 },
    { sprite: 59, color: 2, text: 'Tool Shop', scale: 1 },
];
